...
class Dutch extends Language
{
    public function translations()
    {
        return array(
            ...
            "party.invite" => "§6heeft je uitgenodigd om hun party te joinen! Doe §c/party accept {%1} §6om de uitnodiging the accepteren.",
            "party.invited" => "§aInvited §b{%1} §anaar je party.",
            ...
            "party.welcome" => "§6Welkom bij §b{%1}'s §6party!",
